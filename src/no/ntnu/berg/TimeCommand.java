...
/**
 * This command returns the current server time for the server in the hours, minutes, seconds format.
 * The command doses currently not support any additional arguments.
 * 
